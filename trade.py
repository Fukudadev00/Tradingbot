...
while(1):
    bscprice = getPrice('0x10ED43C718714eb63d5aA57B78B54704E256024E', BSC_url, path=["0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56", "0x68784ffaa6Ff05E3e04575DF77960DC1D9F42b4a"], amount=10, decimal=[18,18])
    print('BSC price: ', bscprice)
    polyprice = getPrice('0xC0788A3aD43d79aa53B09c2EaCc313A787d1d607', Poly_url, path=['0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174','0x04429fbb948BBD09327763214b45e505A5293346'],amount=10, decimal=[6, 18])
    print('Polygon price: ', polyprice)
    auroprice = getPrice('0x2CB45Edb4517d5947aFdE3BEAbF95A582506858B', Auro_url, path=['0xB12BFcA5A55806AaF64E99521918A4bf0fC40802','0x2BAe00C8BC1868a5F7a216E881Bae9e662630111'],amount=10, decimal=[6,18])
